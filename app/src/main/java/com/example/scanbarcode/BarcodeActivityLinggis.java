...
public class BarcodeActivityLinggis extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_layout_barcode_linggis);
    }
    ...
    public void saveBarcodeToGallery(View view) {
        ...
        String filename = "barcode_linggis.jpg";
